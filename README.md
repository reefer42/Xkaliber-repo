# Xkaliber Repository updates : our official iso is bottom of page
          ...
          TYPE "xmenu" or "xmenu.sh" TO VIEW REPO OPTIONS xmenu.sh list all packages in one window
...
installing official repo may take a min though it will look like nothing is happening . remember to do sudo update so new repo is detected after instaling first time and remember to launch xdocker before installing else after 
...
Xkaliber OS offers unique software solutions and enhancements that go beyond what's typically available on your native system. (older pc's may require you to enable virtualization in Bios)
